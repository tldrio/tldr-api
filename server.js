...
app.put('/forum/topics/:slug/:id', routes.voteOnTopic);
...
app.get('/forum/topics/:slug/:id', middleware.attachRenderingValues, routes.website_forumShowTopic);   // Show a whole topic
app.post('/forum/topics/:slug/:id', middleware.attachRenderingValues, routes.website_forumAddPost, routes.website_forumShowTopic);  // Post something to this topic
