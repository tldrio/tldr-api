...
switch(env) {
  case 'development':
    ...
    , bcryptRounds: 6
    , pageScript:'src="http://localhost:8888/page/src/page.js"'
    , basePageAssets : 'http://localhost:8888/page/assets'
    };
    break;
  ...
  case 'production':
    ...
    , locals: { pageScript:'src="http://tldr.io/page/src/page.js"'
              , basePageAssets: 'http://tldr.io/page/assets' } // This replaces the `view options` in express 3.x
  ...
  case 'staging':
    ...
    , locals: { pageScript:'src="http://tldr.io/page/staging/src/page.js"'
              , basePageAssets: 'http://tldr.io/page/staging/assets' } // This replaces the `view options` in express 3.x
  ...
  case 'test':
    ...
    , locals:  { pageScript:'data-main="http://localhost:8888/dist/page/local/src/page.js" src="http://localhost:8888/src/vendor/require/require.js"'
               , basePageAssets : 'http://localhost:8888/dist/page/local/assets' } // This replaces the `view options` in express 3.x
    };
    break;
