var express = require('express')
  ...
  , clientsDir = process.env.TLDR_CLIENTS_DIR
  , config;
...
switch(env) {
  case 'development':
    ...
    , redisDb: 0
    , pageTemplates: clientsDir + '/dist/page/local/templates'
    , cssNamesLocation: clientsDir + 'dist/page/local/lib/css-names'
  ...
  case 'production':
    ...
    , redisDb:0
    , pageTemplates: 'http://tldr.io/page/templates'
    , cssNamesLocation: 'http://tldr.io/page/lib/css-names'
  ...
  case 'staging':
    ...
    , cookieMaxAge: 7*24*3600*1000
    , redisDb:0
    , pageTemplates: 'http://tldr.io/page/staging/templates'
    , cssNamesLocation: 'http://tldr.io/page/staging/lib/css-names'
