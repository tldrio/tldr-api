...
switch(env) {
  case 'development':
    ...
    , websiteUrl: 'http://localhost:8888/dist/website/local/public/'
    ...
    , locals: { pageScript:'data-main="http://localhost:8888/dist/page/local/src/page.js" src="http://localhost:8888/src/vendor/require/require.js"'
                             , pageCss: 'http://localhost:8888/dist/page/local/assets/css/page.css' } // This replaces the `view options` in express 3.x
    };
    break;
  ...
  case 'production':
    ...
    , locals: { pageScript:'src="http://tldr.io/page/src/page.js"'
              , pageCss: 'http://tldr.io/page/assets/css/page.css' } // This replaces the `view options` in express 3.x
  ...
  case 'staging':
    ...
    , locals: { pageScript:'src="http://tldr.io/page/staging/src/page.js"'
              , pageCss: 'http://tldr.io/page/staging/assets/css/page.css' } // This replaces the `view options` in express 3.x
