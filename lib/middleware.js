...
function calculateRenderingValues (req, cb) {
  ...
  values.pageMetaProperties.push({ property: 'og:title', content: 'tl;dr' });
  values.pageMetaProperties.push({ property: 'og:type', content: 'website' });
  values.pageMetaProperties.push({ property: 'og:url', content: 'http://tldr.io' });
  values.pageMetaProperties.push({ property: 'og:image', content: 'http://tldr.io/assets/img/fbicon.png' });
  values.pageMetaProperties.push({ property: 'og:site_name', content: 'tldr.io' });
  values.pageMetaProperties.push({ property: 'og:description', content: 'The Web, Summarized by People' });
  values.pageMetaProperties.push({ property: 'fb:app_id', content: '250458838406360' });

  // If logged user display his infos, notifications
