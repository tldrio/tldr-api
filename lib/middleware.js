...
/*
 * Forcing resend of cookie everytime by modifying the session at random,
 * which forces session to resend the cookie. It will then be sent with the good
 * domain value
 */
function resendCookieWithGoodDomain (req, res, next) {
  req.session.uselessField = customUtils.uid(10);
...
module.exports.resendCookieWithGoodDomain = resendCookieWithGoodDomain;
