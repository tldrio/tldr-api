...
, blockSuccess: 'Success, the tldr was blocked'
, blockFailure: 'Something went wrong, this tldr is still not blocked'
...
, couldntAllowHover: 'Oops, something is very wrong, we can\'t allow you to hover.'
...
, missingCategoriesNames: 'You must provides some categories'
...
, threadDoesntExist: 'This thread doesnt exist'
...
, validateCategories: 'The categories array should not be empty and should contain only valid categories'
...
, validateThreadTitle: 'A thread title should not be empty or more than 100 characters!'
...
, se_retrievingThread: 'Strange error while retrieving the thread'
...
, adminUserDeleted: '[USER DELETION]User {{username}} deleted his account'
, adminUserSubscribedToTldr: '[SUBSCRIPTION]New subscription for a tl;dr'
...
, congratsTldrViews: 'tldr.io - You have over 50 views on one of your tl;dr!'
...
, newQuerystringOffender: 'A new querystring offender has appeared!'
, passwordWasReset: 'tldr.io - Your password was reset successfully'
, postToForum: 'tldr.io - User {{lastPostCreator.username}} just posted to a thread you follow in the forum'
, readReport: 'tldr.io - tl;dr of your impact on the world this week'
, resetPassword: 'tldr.io - Reset your password'
, subscriptionTldrCreated: 'tldr.io - The tl;dr you were looking for is now available'
...
messages.topic = {
  badType: 'A topic can only be a category or a domain'
};
