 ...
 * @param {Object} req the request. Depending on where the logging function is called, some fields such as user may not be populated
 * @param {String or Object} toLog either a short message or a whole object to be logged
 */
bunyanLogger.customInfo = function (level, req, toLog) {
  var finalLog = {}, prop;
