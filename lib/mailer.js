...
function sendConfirmationToken (user, serverUrl, callback) {

  var link = serverUrl + '/confirm?confirmationToken=' + encodeURIComponent(user.confirmationToken)
...
function sendNewConfirmationToken (user, serverUrl, callback) {
...
module.exports.sendConfirmationToken = sendConfirmationToken;
