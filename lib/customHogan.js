...
/**
 * Compiles the templates and set up express to use this as its rendering module
 ...
 *        {String} baseDir The base directory where all templates are, not to be repeated in all partials names
...
module.exports = function (app, options) {
  ...
  templatesDir = options.baseDir;
  targets = options.toCompileDirs;

  function initializeRendering(err) {
