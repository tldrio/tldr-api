...
async.waterfall([
  ...
  // Add the lastActiveMailSent field to all users
, function (cb) {
    var i = 0;

    console.log('Adding lastActiveMailSent field to the User schema');
    ...
    User.find({}, function(err, users) {
      ...
      , function (cb) {
          console.log('Adding lastActiveMailSent to: ' + users[i]._id);

          users[i].lastActiveMailSent = false;
  ...
  // test that all the users docs have a lastActiveMailSent field
, function (cb) {
